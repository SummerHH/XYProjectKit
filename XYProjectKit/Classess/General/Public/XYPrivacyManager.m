...
@implementation XYPrivacyManager
...
+ (void)openIPhoneSystemSettingPageBeforeMessage:(NSString *)message {
    ...
    UIAlertController *alertDialog = [UIAlertController alertControllerWithTitle:@"提示" message:message preferredStyle:UIAlertControllerStyleAlert];
    ...
    [[UIViewController currentNavigationController] presentViewController:alertDialog animated:YES completion:nil];
}

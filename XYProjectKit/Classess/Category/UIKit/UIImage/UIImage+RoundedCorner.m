...
- (UIImage *)xy_imageWithRoundedCornersAndSize:(CGSize)sizeToFit cornerRadius:(CGFloat)radius {
    return [UIImage xy_imageWithRoundedCornersAndSize:sizeToFit cornerRadius:radius borderColor:nil borderWidth:0 backgroundColor:nil backgroundImage:self withContentMode:UIViewContentModeScaleAspectFill];
}
...
- (UIImage *)xy_imageWithRoundedCornersAndSize:(CGSize)sizeToFit cornerRadius:(CGFloat)radius withContentMode:(UIViewContentMode)contentMode {
    return [UIImage xy_imageWithRoundedCornersAndSize:sizeToFit cornerRadius:radius borderColor:nil borderWidth:0 backgroundColor:nil backgroundImage:self withContentMode:contentMode];
}
...
+ (UIImage *)xy_imageWithRoundedCornersAndSize:(CGSize)sizeToFit cornerRadius:(CGFloat)radius borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth {
    return [UIImage xy_imageWithRoundedCornersAndSize:sizeToFit cornerRadius:radius borderColor:borderColor borderWidth:borderWidth backgroundColor:nil backgroundImage:nil withContentMode:UIViewContentModeScaleToFill];
}
...
+ (UIImage *)xy_imageWithRoundedCornersAndSize:(CGSize)sizeToFit cornerRadius:(CGFloat)radius backgroundColor:(UIColor *)backgroundColor {
    return [UIImage xy_imageWithRoundedCornersAndSize:sizeToFit cornerRadius:radius borderColor:nil borderWidth:0 backgroundColor:backgroundColor backgroundImage:nil withContentMode:UIViewContentModeScaleToFill];
}
...
+ (UIImage *)xy_imageWithRoundedCornersAndSize:(CGSize)sizeToFit cornerRadius:(CGFloat)radius borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth backgroundColor:(UIColor *)backgroundColor backgroundImage:(UIImage *)backgroundImage withContentMode:(UIViewContentMode)contentMode {
    return [UIImage xy_imageWithRoundedCornersAndSize:sizeToFit radius:XYRadiusMake(radius, radius, radius, radius) borderColor:borderColor borderWidth:borderWidth backgroundColor:backgroundColor backgroundImage:backgroundImage withContentMode:contentMode];
}
...
+ (UIImage *)xy_imageWithRoundedCornersAndSize:(CGSize)sizeToFit radius:(XYRadius)radius borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth backgroundColor:(UIColor *)backgroundColor backgroundImage:(UIImage *)backgroundImage withContentMode:(UIViewContentMode)contentMode {
    ...
    radius = [UIImage transformationRadius:radius size:sizeToFit borderWidth:borderWidth];
...
+ (XYRadius)transformationRadius:(XYRadius)radius size:(CGSize)size borderWidth:(CGFloat)borderWidth {

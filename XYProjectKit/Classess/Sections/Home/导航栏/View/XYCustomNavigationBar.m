...
@interface XYCustomNavigationBar ()
...
@implementation XYCustomNavigationBar
- (void)dealloc {
...
-(void)updateFrame {
    NSInteger top = kStatusBarHeight;
    NSInteger margin = 0;
...
#pragma mark - 左右按钮
- (void)xy_setLeftButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted title:(NSString *)title titleColor:(UIColor *)titleColor {
...
- (void)xy_setLeftButtonWithImage:(UIImage *)image title:(NSString *)title titleColor:(UIColor *)titleColor {
    [self xy_setLeftButtonWithNormal:image highlighted:image title:title titleColor:titleColor];
}

- (void)xy_setLeftButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted {
    [self xy_setLeftButtonWithNormal:normal highlighted:highlighted title:nil titleColor:nil];
}

- (void)xy_setLeftButtonWithImage:(UIImage *)image {
    [self xy_setLeftButtonWithNormal:image highlighted:image title:nil titleColor:nil];
}

- (void)xy_setLeftButtonWithTitle:(NSString *)title titleColor:(UIColor *)titleColor {
    [self xy_setLeftButtonWithNormal:nil highlighted:nil title:title titleColor:titleColor];
}

- (void)xy_setRightButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted title:(NSString *)title titleColor:(UIColor *)titleColor {
...
- (void)xy_setRightButtonWithImage:(UIImage *)image title:(NSString *)title titleColor:(UIColor *)titleColor {
    [self xy_setRightButtonWithNormal:image highlighted:image title:title titleColor:titleColor];
}

- (void)xy_setRightButtonWithNormal:(UIImage *)normal highlighted:(UIImage *)highlighted {
    [self xy_setRightButtonWithNormal:normal highlighted:highlighted title:nil titleColor:nil];
}

- (void)xy_setRightButtonWithImage:(UIImage *)image {
    [self xy_setRightButtonWithNormal:image highlighted:image title:nil titleColor:nil];
}

- (void)xy_setRightButtonWithTitle:(NSString *)title titleColor:(UIColor *)titleColor {
    [self xy_setRightButtonWithNormal:nil highlighted:nil title:title titleColor:titleColor];
}
